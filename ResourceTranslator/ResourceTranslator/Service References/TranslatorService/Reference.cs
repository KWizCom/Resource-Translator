...
namespace KWizCom.ResourceTranslator.TranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private KWizCom.ResourceTranslator.TranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public KWizCom.ResourceTranslator.TranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        KWizCom.ResourceTranslator.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, KWizCom.ResourceTranslator.TranslatorService.Translation[] translations, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        KWizCom.ResourceTranslator.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options);
        ...
        KWizCom.ResourceTranslator.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options);
        ...
        KWizCom.ResourceTranslator.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : KWizCom.ResourceTranslator.TranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<KWizCom.ResourceTranslator.TranslatorService.LanguageService>, KWizCom.ResourceTranslator.TranslatorService.LanguageService {
        ...
        public KWizCom.ResourceTranslator.TranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, KWizCom.ResourceTranslator.TranslatorService.Translation[] translations, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public KWizCom.ResourceTranslator.TranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options) {
        ...
        public KWizCom.ResourceTranslator.TranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public KWizCom.ResourceTranslator.TranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, KWizCom.ResourceTranslator.TranslatorService.TranslateOptions options) {
